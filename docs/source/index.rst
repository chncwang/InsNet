...
InsNet can be installed according to the instructions below:
...
We illustrate the padding-free dynamic batching mechanism of InsNet as below:
...
The benchmarks for InsNet's traning speed and memory usage on various settings is as below:
...
See the manual reference to know how to use InsNet in detail.
