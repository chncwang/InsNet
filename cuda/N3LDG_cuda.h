...
void FullDivForward(vector<dtype*> numerators,
        ...
        int dim,
        vector<dtype*> &results);
void FullDivBackward(vector<dtype*> &losses,
        ...
        vector<dtype*> &numerator_losses,
        vector<dtype*> &denominator_losses);
void SplitForward(vector<dtype*> &inputs, vector<int> &offsets,
        int count,
        int dim,
        vector<dtype*> &results);
void SplitBackward(vector<dtype*> &losses, vector<int> offsets,
        int count,
        int dim,
...
void PMultiBackward(vector<dtype*> &losses,
...
void PAddForward(vector<vector<dtype*>> &ins, int count,
        ...
        int in_count,
        vector<dtype*> &vals);
void PAddBackward(vector<dtype*> &losses, int count, int dim,
        int in_count,
